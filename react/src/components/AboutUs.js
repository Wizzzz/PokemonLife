                    ...
                    <div className="container">
                        <div className="row about-container">
                            ...
                            <div className="col-lg-6 content order-lg-1 order-2">
                                ...
                                <p>
                                   PokemonLife est un jeu épique où vous incarnez un pokémon dans une aventure remplie de rebondissement ! Prenez place dans un monde rempli original et immersif et devenez le meilleur Pokémon du monde !
                                </p>
                                ...
                                <div className="icon-box wow fadeInUp">
                                    ...
                                    <p className="description">Une énorme carte composée de mystère et de secrets... Accomplissez des quêtes et obtenez les meilleures récompenses inimaginables !</p>
                                </div>
